...
export const ALLOW_TRADING        = false

export const REFERRAL_PROGRAM_ID  = 'x8tA8g5rTmz6gA'

export const FACET_SYSTEM_TRACE   = false
export const SEARCH_SYSTEM_TRACE  = false

export const ALIAS_FOR_PRODUCT    = 'project'
export const FLAGSHIP_SLUG        = 'joe-is-japanese'
